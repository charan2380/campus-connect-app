...
export const StudentProfileFields = ({
  ...
  handleInputChange,
  departmentOptions,
  yearOptions, // ✅ Added yearOptions here
  handleFileChange,
  setCollegeIdFile,
  setCollegeIdPreview,
  setBusIdFile,
        ...
        <div className="sm:col-span-2">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs font-semibold text-indigo-600 hover:text-indigo-800 disabled:text-gray-400"
            >
              {isGeneratingBio ? (
      ...
      <div className="pt-6 border-t">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <FileInputCard
            ...
            label="College ID"
            previewUrl={collegeIdPreview}
            onFileChange={handleFileChange(setCollegeIdFile, setCollegeIdPreview)}
          />
          <FileInputCard
            id="bus-id-upload"
            label="Bus ID"
            previewUrl={busIdPreview}
            onFileChange={handleFileChange(setBusIdFile, setBusIdPreview)}
          />
        </div>
      </div>
    </div>
